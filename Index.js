    ...
    <div className="boxed_wrapper ltr">
        <div id="search-popup" className="search-popup">
            <div className="popup-inner">
                <div className="upper-box clearfix">
                    <figure className="logo-box pull-left"><a href="#"><img src="assets/img/logo.png" alt=""/></a></figure>
                    <div className="close-search pull-right"><span class="far fa-times"></span></div>
                </div>
        ...
        <main class="main-content">
            <section class="banner-style-two p_relative">
                <div class="bg-layer" style="background-image: url(assets/img/banner4.png);"></div>
                <div class="bg-color"></div>
                <div class="pattern-layer" style="background-image: url(assets/img/shape-3.png);"></div>
                <div class="auto-container">
                    <div class="content-box">
                        <span class="sub-title mb_20">Dedication, Experience & Quality</span>
                        ...
                        <div class="btn-box">
                            <a href="#" class="theme-btn">Contact Us <span></span><span></span><span></span><span></span></a>
                        </div>
                    </div>
                </div>
            </section>
            <section class="clients-section style-two">
                <div class="outer-container">
                    <div class="clients-carousel owl-carousel owl-theme owl-dots-none owl-nav-none">
                        <figure class="clients-logo"><a href="#"><img src="assets/img/client.png" alt=""/></a></figure>
                        <figure class="clients-logo"><a href="#"><img src="assets/img/client.png" alt=""/></a></figure>
                        <figure class="clients-logo"><a href="#"><img src="assets/img/client.png" alt=""/></a></figure>
                        <figure class="clients-logo"><a href="#"><img src="assets/img/client.png" alt=""/></a></figure>
                        <figure class="clients-logo"><a href="#"><img src="assets/img/client.png" alt=""/></a></figure>
            ...
            <section class="about-style-two pt_120 pb_120">
                <div class="pattern-layer">
                    <div class="pattern-2" style="background-image: url(assets/img/shape-4.png);"></div>
                </div>
                <div class="auto-container">
                    <div class="row">
                            ...
                            <div class="content_block_one">
                                <div class="content-box mt_25 mr_70 sec-title-animation animation-style2">
                                    <div class="sec-title mb_25">
                                        <span class="sub-title mb_20 title-animation">Pharma</span>
                                        <h2 class="title-animation">We Offer Trusted and Premium Service</h2>
                                    </div>
                            ...
                            <div class="image_block_two">
                                <div class="image-inner">
                                    <div class="image-shape">
                                        <div class="shape-1" style="background-image: url(assets/img/shape/shape-12.png);"></div>
                                        <div class="shape-2" style="background-image: url(assets/img/shape/shape-12.png);"></div>
                                    </div>
                                    <div class="row clearfix">
                                        <div class="col-lg-6 col-md-6 col-sm-12 single-column">
                                            <div class="image-box">
                                                <figure class="image mb_30"><img src="assets/img/about2.png" alt=""/></figure>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 single-column">
                                            <figure class="image pt_100 mt_15"><img src="assets/img/about3.png" alt=""/></figure>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <section class="service-style-two pt_120 pb_120">
                <div class="bg-layer parallax-bg" data-parallax='{"y": 100}' style="background-image: url(assets/img/service-bg.png);"></div>
                <div class="auto-container">
                    ...
                    <div class="tabs-box">
                        <div class="tab-btn-box p_relative mb_110">
                            <ul class="tab-btns tab-buttons clearfix">
                                <li class="tab-btn active-btn" data-tab="#tab-1">Service1</li>
                                <li class="tab-btn" data-tab="#tab-2">Service 2</li>
                            </ul>
                        </div>
                        <div class="tabs-content">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                                        <div class="content_block_two">
                                            <div class="content-box mr_50">
                                                ...
                                                <div class="btn-box"><a href="#" class="theme-btn btn-one">Details<span></span><span></span><span></span><span></span></a></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                                        <div class="image-box ml_80">
                                            <figure class="image"><img src="assets/img/service-2.png" alt=""/></figure>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="tab" id="tab-2">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                                        <div class="image-box ml_80">
                                            <figure class="image"><img src="assets/img/service-1.png" alt=""/></figure>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <section class="speciality-section pt_120 centred sec-title-animation animation-style1">
                <div class="bg-color"></div>
                <div class="bg-layer" style="background-image: url(assets/img/parx2.png);"></div>
                <div class="pattern-layer">
                ...
                <div class="auto-container">
                    <div class="sec-title light mb_70 sec-title-animation animation-style2">
                        <span class="sub-title mb_20 title-animation">Our Speciality</span>
                        <h2 class="title-animation">Morbi varius magna dictum lacus pellentesque</h2>
                    </div>
                    <div class="row clearfix">
                        <div class="col-lg-3 col-md-6 col-sm-12 speciality-block">
                            <div class="speciality-block-one p_relative z_1 title-animation">
                                <div class="inner-box">
                                    <div class="icon-box">
                                    ...
                                    <div class="btn-box p_relative">
                                        <div class="link-icon"><a href="#"><i class="icon-23"></i></a></div>
                                        <div class="link-text"><a href="#">View</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-4 col-md-6 col-sm-12 working-block">
                                <div class="working-block-two">
                                    <div class="inner-box">
                                        <div class="shape" style="background-image: url(assets/img/shape/shape-16.png);"></div>
                                        <div class="icon-box">
                                            <div class="r-hex"><div class="r-hex-inner"></div></div>
            ...
            <section class="events-style-two pt_120">
                <div class="bg-layer" style="background-image: url(assets/img/parx1.png);"></div>
                <div class="auto-container">
                    <div class="sec-title light mb_70 centred sec-title-animation animation-style2">
                    ...
                    <div class="inner-content p_relative">
                        <div class="single-item-carousel owl-carousel owl-theme owl-dots-none nav-style-one">
                            <div class="events-block-one">
                                <div class="inner-box">
                                    <figure class="image-box"><a href="#"><img src="assets/img/event2.png" alt=""/></a></figure>
                                    <div class="lower-content">
                                        <div class="post-date"><h2>01<span>APR</span></h2></div>
                                        ...
                                        <div class="lower-box">
                                            <div class="btn-box"><a href="#" class="theme-btn btn-one">View Event<span></span><span></span><span></span><span></span></a></div>

                                        </div>
                                        <ul class="event-info">
                                            <li><i class="icon-1"></i>10AM</li>
                                            <li><i class="icon-18">Test Location</i></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
            ...
            <section class="faq-section pt_120 pb_120">
                <div class="auto-container">
                    <div class="sec-title mb_70 centred sec-title-animation animation-style2">
                        <span class="sub-title mb_20 title-animation">FAQs</span>
                        <h2 class="title-animation">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</h2>
                    </div>
                    <div class="inner-container">
                        <ul class="accordion-box">
                            <li class="accordion block">
                                <div class="acc-btn"><h4><span>1.</span>What is Lorem ipsum dolor sit amet, consectetur adipiscing elit.?</h4></div>
                            ...
                            <li class="accordion block">
                                <div class="acc-btn"><h4><span>2.</span>What is Lorem ipsum dolor sit amet, consectetur adipiscing elit.l?</h4></div>
                                <div class="acc-content">
                                    <div class="content">
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                                    </div>
      ...
      <div className="outer-container">
        <div className="clients-carousel owl-carousel owl-theme owl-dots-none owl-nav-none">
          ...
          <figure className="clients-logo">
              ...
              <img src="/assets/img/client.png" alt="123" />
...
function Index(){
  ...
  <main className="main-content">
      ...
      <div className="auto-container">
        <div className="content-box">
          ...
          <p>
            ...
            consulting services to drive positive results for clients as they
            prevent and resolve compliance problems and develop new
            pharmaceutical products for regulatory submission 
          </p>
          <div className="btn-box">
            <a href="#" className="theme-btn">
              Contact Us <span />
    ...
    <section className="clients-section style-two">
  <div className="outer-container" style={{ textAlign: 'center', padding: '50px 0' }}>
    <h2>Interested in Collaborating?</h2>
    <a 
      href="https://phase1qualityconsulting.com" 
      target="_blank" 
            ...
            <div className="content_block_one">
              <div className="content-box mt_25 mr_70 sec-title-animation animation-style2">
                <div className="sec-title mb_25">
                  ...
                  <h2 className="title-animation">
                    We Offer Trusted and Dedicated Service
                  </h2>
                </div>
                <div className="text-box mb_45 title-animation">
                  <p>
            ...
            <div className="image_block_two">
              <div className="image-inner">
                ...
                <div className="row clearfix">
                  ...
                  <div className="col-lg-6 col-md-6 col-sm-12 single-column">
                    <figure className="/assets/image pt_100 mt_15">
                      <img src="/assets/img/about3.png" alt="" />
                    </figure>
                  </div>
                </div>
          ...
          <div className="tab-btn-box p_relative mb_110">
            <ul className="tab-btns tab-buttons clearfix">
              ...
              <li className="tab-btn" data-tab="#tab-3">
                GMP Compliance and Assessments
              </li>
